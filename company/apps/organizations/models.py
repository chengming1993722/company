...
class CourseOrg(models.Model):
    ...
    category=models.CharField(max_length=30,choices=(("pxjg","培训机构"),('gr','个人'),("gx","高校")),null=True,blank=True,verbose_name="机构类别")
...
class Teacher(models.Model):
    ...
    image = models.ImageField(upload_to="ogr/teacher/%Y/%m", verbose_name="教师图像",default="")
