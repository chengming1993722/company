...
class Course(models.Model):
    ...
    youneed_know = models.CharField(default='',verbose_name="课程须知",max_length=200)
    ...
    # 定义一个外键的反向查找的方法，self.后面必须小写 与被外键的的字段的模型的名称大小写无关
    def get_users(self):
...
class Video(models.Model):
    ...
    videourl = models.CharField(default='',verbose_name='视频地址',max_length=100)
